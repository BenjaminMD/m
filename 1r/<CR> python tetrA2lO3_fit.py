...
#scatter_w_outline(axs[1][0], t, df['Al2O3_a'], label=r'$\gamma$-Al$_2$O$_3$ lat a', color='blue')
scatter_w_outline(axs[1][0], t, df['Al2O3_a'], label=r'$\gamma$-Al$_2$O$_3$ lat a', color='green')
#scatter_w_outline(axs[1][0], t, df['NiO_a'], label=r'NiO lat', color='orange')
#scatter_w_outline(axs[1][0], t, df['Ni_a'], label=r'Ni lat', color='red')
axs[1][0].set_ylabel('Particle size$\,/\,$nm')
#axs[1][0].set_ylim(7.83, 7.855)
axs[1][0].set_ylim(5.63, 5.67)
